    ...
    <div className="dashboard-content">
      ...
      <div className="stats-grid">
        <div className="stat-card teacher-stat-card blue" onClick={() => window.location.hash = 'internships'}>
          ...
          <h2>Database</h2>
          <p>Student Uploads</p>
          <span className="stat-change">Browse & Verify Records</span>
        </div>
        <div className="stat-card teacher-stat-card green" onClick={() => window.location.hash = 'merit'}>
          <div className="stat-icon">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
              <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z"/>
            </svg>
          ...
          <h2>Rankings</h2>
          <p>Merit Lists</p>
          <span className="stat-change">Generate & view ranks</span>
        </div>
        <div className="stat-card teacher-stat-card blue" onClick={() => window.location.hash = 'internships'}>
          <div className="stat-icon">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">

...
// Get profile
router.get('/:student_id', authMiddleware, catchAsync(async (req, res) => {
...
router.put('/:student_id', authMiddleware, catchAsync(async (req, res) => {
...
// Update skills
router.put('/:student_id/skills', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
...
// Update experiences
router.put('/:student_id/experiences', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
...
// Update certificates
router.put('/:student_id/certificates', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
...
router.put('/:student_id/marksheets', authMiddleware, catchAsync(async (req, res) => {
...
// Register for event
router.post('/:student_id/events/:event_id', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
...
// Join club
router.post('/:student_id/clubs/:club_id', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
...
// Apply for job
router.post('/:student_id/jobs/:job_id', authMiddleware, catchAsync(async (req, res) => {
  const profile = await StudentProfile.findOneAndUpdate(
    { student_id: req.params.student_id },
